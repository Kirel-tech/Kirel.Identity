...
public class KirelUsersController<TUserService,TKey,TUser, TRole,TUserDto,TUserCreateDto,TUserUpdateDto,TClaimDto,TClaimCreateDto,TClaimUpdateDto> : Controller
    where TUserService : KirelUserService<TKey,TUser, TRole,TUserDto,TUserCreateDto,TUserUpdateDto,TClaimDto,TClaimCreateDto,TClaimUpdateDto>
