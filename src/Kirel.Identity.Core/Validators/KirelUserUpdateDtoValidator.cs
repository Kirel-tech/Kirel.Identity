    ...
    where TClaimUpdateDto : KirelClaimUpdateDto
{
    ...
    public KirelUserUpdateDtoValidator(IOptions<IdentityOptions> identityOptions, UserManager<TUser> userManager,
        RoleManager<TRole> roleManager, IHttpContextAccessor httpContextAccessor)
    {
